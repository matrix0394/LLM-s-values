#!/usr/bin/env python3
"""
Generate Fig. S4: East Asia Analysis figures.

Data source: publication-ready processed CSV files.

Output: Supplementary Materials/figures/FigS4/
"""
...
# =============================================================================
# Unified Color Palette (same base as S3/S4)
# =============================================================================
...
def gen_s4a(ea_d, od):
    ...
    plt.tight_layout()
    save_figure(fig, od / 'FigS4A_east_asia_trajectory')
    print("  ✅ Saved: FigS4A_east_asia_trajectory")


def gen_s4b(ea_a, od):
    print("Generating FigS4B...")
    ...
    ax.invert_yaxis()
    plt.tight_layout()
    save_figure(fig, od / 'FigS4B_east_asia_distance_comparison')
    print("  ✅ Saved: FigS4B_east_asia_distance_comparison")

def gen_s4c(ea_a, od):
    print("Generating FigS4C...")
    if len(ea_a) == 0: print("  No data"); return
    ...
    plt.tight_layout()
    save_figure(fig, od / 'FigS4C_east_asia_english_gradient')
    print("  ✅ Saved: FigS4C_east_asia_english_gradient")

def gen_combined(ea_d, ea_a, od):
    """Generate a combined 2-row figure: A (trajectory) on top, B+C on bottom."""
    print("Generating FigS4 combined...")
    if len(ea_d) == 0:
        print("  No data")
        return
    ...
    plt.tight_layout()
    save_figure(fig, od / 'FigS4_east_asia_combined')
    print("  Saved: FigS4_east_asia_combined")


def main():
    print("=" * 60)
    print("Generating Fig. S4: East Asia Analysis")
    print("=" * 60)
    od = PROJECT_ROOT / 'Supplementary Materials' / 'figures' / 'FigS4'
    ...
    print("\n" + "=" * 60)
    print(f"All FigS4 figures saved to: {od}")
    print("=" * 60)
