"""
Generate FigS1: IVS Cultural Map with SVM region fills and labeled countries.
...
Output: Supplementary Materials/figures/FigS1/FigS1_IVS_cultural_map.{png,pdf}
"""
...
OUTPUT_DIR = PROJECT_ROOT / 'Supplementary Materials' / 'figures' / 'FigS1'
...
def plot_svm_region_fills(ax, ivs_data):
    ...
    try:
        ...
        print(f"  ⚠️ SVM boundaries unavailable ({e}), using scatter only")
