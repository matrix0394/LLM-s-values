#!/usr/bin/env python3
"""
Generate supplementary Fig. S2 (model imitation) figures
...
def generate_s2a_consistency_distribution(baseline_df, roleplay_df, output_dir):
    ...
    print("Generating FigS2A: Consistency distribution by model...")
...
def generate_s2b_response_distribution(baseline_df, roleplay_df, output_dir):
    ...
    print("Generating FigS2B: Model flexibility analysis...")
...
def generate_s2c_imitation_shift_by_model(roleplay_df, ivs_df, output_dir):
    ...
    print("Generating FigS2C: Imitation shift by model...")
...
def generate_s2d_country_shift_summary(roleplay_df, ivs_df, output_dir):
    ...
    print("Generating FigS2D: Country shift summary...")
...
def generate_s2e_model_size_analysis(roleplay_df, ivs_df, output_dir):
    ...
    print("Generating FigS2E: Model size analysis...")
...
def generate_s2f_open_vs_closed(roleplay_df, ivs_df, output_dir):
    ...
    print("Generating FigS2F: Open vs closed source analysis...")
    from scipy import stats
...
def generate_s2g_vendor_analysis(roleplay_df, ivs_df, output_dir):
    ...
    print("Generating FigS2G: Model origin analysis...")
    from scipy import stats
...
def generate_s2_combined(accuracy_df, study5_summary, output_dir):
    ...
    print("Generating FigS2 combined figure …")
    ...
    # ---- save ------------------------------------------------------------
    save_figure(fig, output_dir / 'FigS2_combined')
    print("  \u2705 Saved: FigS2_combined")


def main():
    """Main function to generate the frozen Fig. S2 combined figure."""
    print("=" * 60)
    print("Generating Fig. S2: Model imitation (model and response analysis)")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print(f"✅ Frozen FigS2_combined saved to: {output_dir}")
    print("=" * 60)
