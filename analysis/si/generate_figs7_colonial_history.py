#!/usr/bin/env python3
"""
Generate FigS6: Colonial History Analysis figures.
...
Output: SI/figures/S6_Colonial_history/

Figures:
- S6A: East Asian colonial gradient (Hong Kong, Macao, China, Japan, Korea)
- S6B: Hong Kong vs Macao comparison
- S6C: Latin American language variants (Spanish, Portuguese, French)
- S6D: African colonial history limitation report
...
# Output directory
OUTPUT_DIR = FIGURES_DIR / 'S6_Colonial_history'
...
# =============================================================================
# Figure S6A: East Asian Colonial Gradient
# =============================================================================

def generate_s7a_east_asian_gradient(advantage_df: pd.DataFrame):
    """Generate S6A: East Asian colonial gradient."""
    print("\nGenerating FigS6A: East Asian Colonial Gradient...")
    ...
    plt.tight_layout()
    output_path = OUTPUT_DIR / 'S6A_east_asian_gradient'
    save_figure(fig, output_path)
    print(f"  Saved: S6A_east_asian_gradient")


# =============================================================================
# Figure S6B: Hong Kong vs Macao Comparison
# =============================================================================

def generate_s7b_hk_macao_comparison(advantage_df: pd.DataFrame, roleplay_df: pd.DataFrame):
    """Generate S6B: Hong Kong vs Macao comparison."""
    print("\nGenerating FigS6B: Hong Kong vs Macao Comparison...")
    ...
    plt.tight_layout()
    output_path = OUTPUT_DIR / 'S6B_hk_macao_comparison'
    save_figure(fig, output_path)
    print(f"  Saved: S6B_hk_macao_comparison")


# =============================================================================
# Figure S6C: Latin American Language Variants
# =============================================================================

def generate_s7c_latin_america_variants(advantage_df: pd.DataFrame):
    """Generate S6C: Latin American language variants."""
    print("\nGenerating FigS6C: Latin American Language Variants...")
    ...
    plt.tight_layout()
    output_path = OUTPUT_DIR / 'S6C_latin_america_variants'
    save_figure(fig, output_path)
    print(f"  Saved: S6C_latin_america_variants")


# =============================================================================
# Figure S6D: African Colonial History Limitation
# =============================================================================

def generate_s7d_african_limitation(roleplay_df: pd.DataFrame):
    """Generate S6D: African colonial history data limitation report."""
    print("\nGenerating FigS6D: African Colonial History Limitation...")
...
"""
    ...
    plt.tight_layout()
    output_path = OUTPUT_DIR / 'S6D_african_limitation'
    save_figure(fig, output_path)
    print(f"  Saved: S6D_african_limitation")
...
def main():
    """Generate all S6 figures."""
    print("="*80)
    print("Generating FigS6: Colonial History Analysis")
    print("="*80)
    ...
    print("\n" + "="*80)
    print("FigS6 generation complete")
