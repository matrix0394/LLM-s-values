#!/usr/bin/env python3
"""
Generate FigS7: Colonial History Analysis figures.

This script generates colonial history analysis figures (Study 4) for SI,
integrating with the existing SI figure generation system.

Output: SI/figures/S7_Colonial_history/

Figures:
- S7A: East Asian colonial gradient (Hong Kong, Macao, China, Japan, Korea)
- S7B: Hong Kong vs Macao comparison
- S7C: Latin American language variants (Spanish, Portuguese, French)
- S7D: African colonial history limitation report
...
# Import colonial history analysis functions
...
# Output directory
OUTPUT_DIR = FIGURES_DIR / 'S7_Colonial_history'
...
def compute_english_advantage_data(ivs_df: pd.DataFrame, roleplay_df: pd.DataFrame) -> pd.DataFrame:
    ...
    # Create IVS lookup
    ivs_dict = load_ivs_coordinates(PCA_DIR / 'Table_S5_IVS_PCA_coordinates.csv')
...
# =============================================================================
# Figure S7A: East Asian Colonial Gradient
# =============================================================================

def generate_s7a_east_asian_gradient(advantage_df: pd.DataFrame):
    """Generate S7A: East Asian colonial gradient."""
    print("\nGenerating FigS7A: East Asian Colonial Gradient...")
    ...
    plt.tight_layout()
    output_path = OUTPUT_DIR / 'S7A_east_asian_gradient'
    save_figure(fig, output_path)
    print(f"  Saved: S7A_east_asian_gradient")


# =============================================================================
# Figure S7B: Hong Kong vs Macao Comparison
# =============================================================================

def generate_s7b_hk_macao_comparison(advantage_df: pd.DataFrame, roleplay_df: pd.DataFrame):
    """Generate S7B: Hong Kong vs Macao comparison."""
    print("\nGenerating FigS7B: Hong Kong vs Macao Comparison...")
    ...
    plt.tight_layout()
    output_path = OUTPUT_DIR / 'S7B_hk_macao_comparison'
    save_figure(fig, output_path)
    print(f"  Saved: S7B_hk_macao_comparison")


# =============================================================================
# Figure S7C: Latin American Language Variants
# =============================================================================

def generate_s7c_latin_america_variants(advantage_df: pd.DataFrame):
    """Generate S7C: Latin American language variants."""
    print("\nGenerating FigS7C: Latin American Language Variants...")
    ...
    plt.tight_layout()
    output_path = OUTPUT_DIR / 'S7C_latin_america_variants'
    save_figure(fig, output_path)
    print(f"  Saved: S7C_latin_america_variants")


# =============================================================================
# Figure S7D: African Colonial History Limitation
# =============================================================================

def generate_s7d_african_limitation(roleplay_df: pd.DataFrame):
    """Generate S7D: African colonial history data limitation report."""
    print("\nGenerating FigS7D: African Colonial History Limitation...")
...
"""
    ...
    plt.tight_layout()
    output_path = OUTPUT_DIR / 'S7D_african_limitation'
    save_figure(fig, output_path)
    print(f"  Saved: S7D_african_limitation")
...
def main():
    """Generate all S7 figures."""
    print("="*80)
    print("Generating FigS7: Colonial History Analysis")
    print("="*80)
    ...
    # Generate figures
    generate_s7a_east_asian_gradient(advantage_df)
    generate_s7b_hk_macao_comparison(advantage_df, roleplay_df)
    generate_s7c_latin_america_variants(advantage_df)
    generate_s7d_african_limitation(roleplay_df)
    
    print("\n" + "="*80)
    print("FigS7 generation complete")
