#!/usr/bin/env python3
"""
Generate Fig. S4: English Advantage and Orientalism Analysis figures.

This script generates all S4 figures directly from SI/pca data,
without depending on external analysis results.

Output: SI/figures/FigS4/

Figures:
- S4A: Cultural regions language effect (bar chart)
- S4B: English advantage distribution and rankings (histogram + top/bottom)
- S4C: Islamic vs Western comparison
- S4D: Geographic gradient trend (line chart)
...
from si_config import (
    ...
    load_ivs_data, load_roleplay_data, save_figure, set_publication_style
)
...
def generate_s4a_cultural_regions(advantage_df: pd.DataFrame, output_dir: Path):
    """Generate FigS4A: Cultural regions language effect."""
    print("Generating FigS4A: Cultural regions language effect...")
    ...
    save_figure(fig, output_dir / 'FigS4A_cultural_regions_language_effect')
    print("  ✅ Saved: FigS4A_cultural_regions_language_effect")


def generate_s4b_orientalism_validation(advantage_df: pd.DataFrame, output_dir: Path):
    """Generate FigS4B: English advantage distribution and rankings."""
    print("Generating FigS4B: English advantage distribution and rankings...")
    ...
    plt.tight_layout()
    save_figure(fig, output_dir / 'FigS4B_ea_distribution_and_rankings')
    print("  ✅ Saved: FigS4B_ea_distribution_and_rankings")


def generate_s4c_islamic_vs_western(advantage_df: pd.DataFrame, output_dir: Path):
    """Generate FigS4C: Islamic vs Western comparison."""
    print("Generating FigS4C: Islamic vs Western comparison...")
    ...
    plt.tight_layout()
    save_figure(fig, output_dir / 'FigS4C_islamic_vs_western_comparison')
    print("  ✅ Saved: FigS4C_islamic_vs_western_comparison")


def generate_s4d_geographic_gradient(advantage_df: pd.DataFrame, output_dir: Path):
    """Generate FigS4D: Geographic gradient trend."""
    print("Generating FigS4D: Geographic gradient trend...")
    ...
    plt.tight_layout()
    save_figure(fig, output_dir / 'FigS4D_geographic_gradient')
    print("  ✅ Saved: FigS4D_geographic_gradient")
...
def main():
    ...
    print("=" * 60)
    print("Generating Fig. S4: English Advantage and Orientalism")
    print("Data source: SI/pca/ (self-contained)")
    print("=" * 60)
    
    # Output directory
    output_dir = FIGURES_DIR / 'FigS4'
    ...
    print("\nGenerating figures...")
    generate_s4a_cultural_regions(advantage_df, output_dir)
    generate_s4b_orientalism_validation(advantage_df, output_dir)
    generate_s4c_islamic_vs_western(advantage_df, output_dir)
    generate_s4d_geographic_gradient(advantage_df, output_dir)
    
    print("\n" + "=" * 60)
    print(f"✅ All S4 figures saved to: {output_dir}")
    print("   Generated: FigS4A, FigS4B, FigS4C, FigS4D")
    print("=" * 60)
