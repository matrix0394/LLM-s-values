#!/usr/bin/env python3
"""Generate FigS6: East Asia Analysis. Data source: SI/pca/ (self-contained)"""
import sys
...
def gen_s6a(ea_d, od):
    ...
    ax.set_title('FigS6A: East Asia Cultural Coordinate Trajectory', fontsize=14, fontweight='bold', pad=20)
    ...
    plt.tight_layout()
    save_figure(fig, od / 'FigS6A_east_asia_trajectory')
    print("  ✅ Saved: FigS6A_east_asia_trajectory")


def gen_s6b(ea_d, od):
    print("Generating FigS6B...")
    if len(ea_d) == 0: print("  No data"); return
    ...
    ax.set_title('FigS6B: East Asia Cultural Distance by Language\n(Lower = Better imitation)', fontsize=14, fontweight='bold', pad=15)
    ax.legend(title='Language', loc='upper right', fontsize=8)
    ax.grid(axis='y', alpha=0.3)
    plt.tight_layout()
    save_figure(fig, od / 'FigS6B_east_asia_distance_comparison')
    print("  ✅ Saved: FigS6B_east_asia_distance_comparison")

def gen_s6c(ea_a, od):
    print("Generating FigS6C...")
    ...
    ax.set_title('FigS6C: East Asia English Advantage Gradient\n(All models averaged)', fontsize=14, fontweight='bold', pad=20)
    ...
    plt.tight_layout()
    save_figure(fig, od / 'FigS6C_east_asia_english_gradient')
    print("  ✅ Saved: FigS6C_east_asia_english_gradient")

def main():
    print("=" * 60)
    print("Generating FigS6: East Asia Analysis")
    print("Data source: SI/pca/ (self-contained)")
    print("=" * 60)
    od = FIGURES_DIR / 'S6_East_Asia_analysis'
    ...
    gen_s6c(ea_a, od)
    print("\n" + "=" * 60)
    print(f"✅ All S6 figures saved to: {od}")
    print("=" * 60)
