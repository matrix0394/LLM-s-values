...
# =============================================================================
# Color Definitions - Cultural Regions (Based on WVS/Inglehart-Welzel Map)
# Darker, more saturated colors for better visibility
# =============================================================================
REGION_COLORS = {
    'Confucian': '#D97B3A',              # Darker orange - 儒家文化圈
    'Protestant Europe': '#C0D030',       # Darker yellow-green - 新教欧洲
    'Latin America': '#5A9FBD',          # Darker blue - 拉丁美洲
    'Catholic Europe': '#8AB86E',        # Darker green - 天主教欧洲
    'English-Speaking': '#E8D040',       # Darker yellow - 英语国家
    'African-Islamic': '#909090',        # Darker gray - 非洲-伊斯兰
    'West & South Asia': '#E0A840',      # Darker orange-yellow - 西亚南亚
    'Orthodox Europe': '#D86B6B',        # Darker red/pink - 东正教欧洲
    'Other': '#CCCCCC'                   # Light gray - 其他
}
...
def load_roleplay_data() -> pd.DataFrame:
    ...
    return pd.read_csv(roleplay_path)
